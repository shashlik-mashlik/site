              ...
              <div class="overlay_item"> <img src="<?=$images_url?>?" alt="<?=$el['name']?>" title="<?=$el['name']?>">
                <div class="overlay">
                  <div class="icons">
                    ...
                    <!-- Button -->
                    <div class="button"> 
                      <span id="add_cart_btn_parent_<?php echo $el['id'] ?>" class="btn btn-gold" onclick="basketAjax.changeButton(<?php echo $el['id'] ?>);"><i id="add_cart_btn_<?php echo $el['id'] ?>" class="fa fa-shopping-cart"></i></span>
