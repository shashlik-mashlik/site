              ...
              <div class="overlay_item"> <img src="<?=$images_url?>?" alt="<?=$el['name']?>" title="<?=$el['name']?>">
                <div class="overlay">
                  <div class="icons">
                    ...
                    <!-- Button -->
                    <div class="button"> 
                      <span class="btn btn-gold" onclick="basketAjax.add_to_cart(<?php echo $el['id'] ?>); basketAjax.changeButton(<?php echo $el['id'] ?>);"><i id="add_cart_btn_<?php echo $el['id'] ?>" class="fa fa-shopping-cart"></i><i id="ok_cart_btn_<?php echo $el['id'] ?>" class="fa fa-check" style="display: none;"></i></span>
