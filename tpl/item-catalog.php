          ...
          <div class="menu-thumb-slide col-md-6">
            <div id="single-img" class="owl-carousel">
              <div class="item"><img src="<?=$images_url?>" alt="<?=$el['name']?>" title="<?=$el['name']?>"></div>
							<? //if (file_exists('./upload/catalog/'.$el['id'].'_1.jpg')) {?><div class="item"><img src="<?='/upload/catalog/'.$el['id'].'_1.jpg'?>" alt="<?=$el['name']?>" title="<?=$el['name']?>"></div><?//}?>
			  			<? //if (file_exists('./upload/catalog/'.$el['id'].'_2.jpg')) {?><div class="item"><img src="<?='/upload/catalog/'.$el['id'].'_2.jpg'?>" alt="<?=$el['name']?>" title="<?=$el['name']?>"></div><?//}?>
							<? //if (file_exists('./upload/catalog/'.$el['id'].'_3.jpg')) {?><div class="item"><img src="<?='/upload/catalog/'.$el['id'].'_3.jpg'?>" alt="<?=$el['name']?>" title="<?=$el['name']?>"></div><?//}?>
            </div>
