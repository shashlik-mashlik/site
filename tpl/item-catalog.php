          ...
          <div class="menu-desc col-md-6">
            ...
            <div class="desc-content">
              ...
              <a class="added_to_cart wc-forward" style="visibility: hidden; margin-top: 12px;" id="go_to_cart_<?php echo $el['id'] ?>" href="/basket">Перейти в корзину</a>
									<div class="social pull-right ya-share2" data-image="<?=$images_url?>" data-title="Самые вкусные шашлыки в СПб. Я заказываю здесь! <?=$el['name']?>" data-services="vkontakte,facebook,odnoklassniki"></div>
