        ...
        <div class="row">
          ...
          <div class="menu-desc col-md-6">
            ...
            <div class="desc-content">
              ...
              <span onclick="basketAjax.changeButton(<?php echo $el['id'] ?>);" class="shop btn btn-gold"data-toggle="tooltip" data-original-title="Добавить в корзину"><i id="add_cart_btn_<?php echo $el['id'] ?>" class="fa fa-shopping-cart"></i></span>
