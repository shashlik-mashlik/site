...
include('tpl/basket/basket-functions.php');
	...
	if(isset($_GET['add_basket_item'])) 	{	add_to_cart($_GET['add_basket_item']);	}
	if(isset($_GET['remove_from_cart']))	{	remove_from_cart($_GET['remove_from_cart']); 	}	
	if(isset($_GET['del_basket_item']))		{	del_basket_item($_GET['del_basket_item']); 	}		
            ...
            <table class="table table-striped table-responsive table-cart">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="menu_single.html"><img src="<?=$images_url?>" alt="<?=$product['name']?>" title="<?=$product['name']?>" class="img-thumbnail"> <?=$product['name']?></a> </td>
                  ...
                  <td><!-- input group minus & plus-->
                    ...
                    <div class="input-group plus-minus"> 
                    		...
                    		<table style="border: none"><tr>
								...
								<td class="active"><a href="/basket/?del_basket_item=<?php echo $key?>" type="submit" title="Удалить один лот"><span class="glyphicon glyphicon-minus"></span></a></td>
								<td class="active" style="width: 70px;">
									
									<input readonly class="" type="text" size="2" id="product_count_<?php echo $key;?>" value="<?php echo $_SESSION['products'][$key]['count']?>" /> 
									</td>
								<td class="active"><a href="/basket/?add_basket_item=<?php echo $key?>" type="submit" title="Добавить один лот"><span class="glyphicon glyphicon-plus"></span></a></td>
                  ...
                  <td><span class="total"><?php echo ($_SESSION['products'][$key]['count']*$_SESSION['products'][$key]['coast'])?> руб. </span> 
                  <a class="pull-right" href="/basket/?remove_from_cart=<?php echo $key?>"><i class="fa fa-times"></i></a></td>
                </tr>
